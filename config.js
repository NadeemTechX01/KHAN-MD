...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "KHAN-MD~v3gXXBgD#yDpQeh0mcjKNS9QHNYe5vA55BiNkxo-_9gkuG2TUU34",
// add your Session Id 
...
OWNER_NAME: process.env.OWNER_NAME || "Nadeem Khan",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Nadeem Khan*",
// add bot owner name    
